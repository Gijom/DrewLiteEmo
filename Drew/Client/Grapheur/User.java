...
/** Classe des Utilisateurs du Grapheur. La classe User contient les informations sur
    les utilisateurs : comme leur nom, leur num�ro d'enregistrement, leur couleur etc.
*/
public class User {
    ...
    */
    ...
    /** Vaut <b>false</b> si l'utilisateur a �t� retir� de l'argumentation.
    */
    ...
    /** Construit un nouvel utilisateur avec des valeurs par d�faut :
	<UL>
	<LI>nom = "toto" </LI>
	<LI>teinte = 0.0 </LI>
	<LI>engaged = true</LI>
    ...
    */
    ...
    /** Construit un nouvel utilisateur en sp�cifiant son nom.
    */
    public User(String s){
	this(s,0,true);
    }

    /** Construit un nouvel utilisateur en sp�cifiant son nom et son rang.
	L'utilisateur est engag� par d�faut.
    */
    public User(String s, int c){
	this(s, c, true);
    }

    /** Construit un nouvel utilisateur en sp�cifiant son nom, son rang 
     * et son engagement.
    */
    ...
    /** Conna�tre le statut d'un utilisateur (en jeu ou non)*/
    public boolean getUserEngaged() {
	    return(engaged);
    }
    
    /** D�finir le nom d'un utilisateur */
    ...
    /** D�finir le statut d'un utilisateur (le retirer du jeu ou non)*/
    ...
    */
    ...
    /** Attribue une teinte particuli�re � l'utilisateur */
