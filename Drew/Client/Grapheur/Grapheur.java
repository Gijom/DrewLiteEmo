...
/** Fen�tre (Frame) permettant le dessin de graphes argumentatifs.
  @author Matthieu Quignard
...
public class Grapheur 
	...
	/** Dimension de la fen�tre initialis�e � -1 -1 pour forcer le
	  redimensionnement.
	  */
	Dimension minSize = new Dimension(-1,-1);

	/** Panneau gauche de la fen�tre affichant la liste des participants
	...
	/** Bouton pour cr�er une nouvelle bo�te */
	ImageButton nvBoite;

	/** Bouton pour cr�er une nouvelle fl�che*/
	...
	/** Panel avec l'�tat courant de l'argument pour l'utilisateur courant */
	Panel panel;
	...
	/** entier m�morisant l'utilisateur courant. C'est pour savoir si on a chang� et qu'on doit rafraichir les panneaux */
	int oldIndex = -2 ;

	/** Liste des utilisateurs connect�s (information provenant du centre de connexion*/
	Vector connectedUsers;

    	/** Case � cocher pour ajuster automatiquement le graphe */
	...
	*/
	...
	/** Reconstruit la liste (graphique et logique) des utilisateurs engag�s 
	  apr�s modification de la variable <b>protagonists</b> interne � l'objet Argumentation.
	  <p> Cette m�thode red�finit currentUser, argu.protagonists.
	...
	/** Actionne l'affichage ou la disparition des infos relatives
	  � la position de l'utilisateur courant par rapport � l'argument
	  courant
	  */
	...
	/** Affiche ou non la possibilit� d'ajouter de nouvelles boites
	  ou fleches. D�pend en fait de l'existence d'un utilisateur courant
	  */
	...
	/** Gestion des �v�nements produits sur les boutons g�r�s par
	  le Grapheur : Editer et Quitter. Les autres sont enregistr�s
	  aupr�s de Argumentation.
	  */ 
	...
	/** Gestion des �v�nements produits sur la fen�tre */
	...
	/** Gestion des �venements sur la liste des protagonistes et 
	  les boites � cocher "Pour" et "Contre".
	  Un changement de s�lection occasionne le changement de
	  l'utilisateur courant et provoque pas mal de mises
	  � jour. Le changement d'attitude sur l'argument �galement
	...
	// Impl�mentation du Cooperative Module
	...
	/** D�marrage du module */
	public void init(){
		/** Mise sur �coute de cette fen�tre. Elle s'�coute elle-m�me
		  puisqu'elle impl�mente la fonctionnalit� d'une interface
		  WindowListener. Elle doit comporter toutes les m�thodes de 
		  gestions d'�v�nements WindowEvent.
		  */
		...
		//add(nvFleche,c); // gdyke 07.2007 pas de cr�ation de nouvelles boites
